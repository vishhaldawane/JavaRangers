...
public class UpdateRecordTest {
    ...
    public static void main(String[] args) {
        ...
        //transient object - in memory object
                Department dept = new Department(); //em.find(Department.class,10); //this will fire the SELECT query
                ...
                dept.setDepartmentName("MOVIE"); //now change the dept's content
                dept.setDepartmentLocation("NewMUMBAI");
