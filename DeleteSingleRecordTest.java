...
Dept dept = spring will produce the object
tell hibernate to store this dept object
...
public class DeleteSingleRecordTest {
	...
	// write your code here
        ...
        try {
            ...
            System.out.println("Enter EXISTING department number to DELETE : "); //your primary key value
            ...
            if(!result.next()) { //oh...means if the record is NOT there....
                ...
                preparedStatement = connection.prepareStatement("DELETE FROM MYDEPT WHERE DEPTNO=?");
                System.out.println("PreparedStatement is created....");
            }

            preparedStatement.setInt(1,existingDeptNumber);

            System.out.println("tyring to run the query....");
            int numebrOfRowsDeleted = preparedStatement.executeUpdate();
            System.out.println("Number of rows deleted : "+numebrOfRowsDeleted);
